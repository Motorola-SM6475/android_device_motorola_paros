...
# Audio
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/audio/sku_parrot/mixer_paths_parrot_mtp.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/sku_parrot/mixer_paths_parrot_mtp.xml \
    $(LOCAL_PATH)/configs/audio/sku_parrot/resourcemanager_parrot_mtp.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/sku_parrot/resourcemanager_parrot_mtp.xml \
...
$(call inherit-product, device/motorola/sm6475-common/common.mk)
...
# Vibrator
$(call soong_config_set,qti_vibrator,effect_lib,libqtivibratoreffect.moto_sm6475-richtap)
